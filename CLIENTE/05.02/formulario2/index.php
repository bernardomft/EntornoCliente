...
. en el body llamamos a la función form de php que imprime el formlario html
. php crea el formulario en todas las llamadas por tanto hay recarga de la pagina action="" y novalidate
. primera carga: carga el formulario usa valores por defecto
. siguientes cargas: php recibe los valores en REQUEST, valida, imprime el formulario, marcando errores, mantener la memoria del formulario
. php dinamicamente marca en el formulario: requeridos,clases,valores,selectores
. usamos una hoja de estilos pero las clases tb son dinamicas en php

lenguaje php: global, filter_var, preg_match, explode, count, is_numeric, checkdate
...
?>
<h1>propuesta formulario en php</h1>
