<?php
// 20141122
// version de -1 modificada para solicitar datos al servidor
// php: file_get_contents, str_replace, explode, exit
// js: responseText, responseXML, outerHTML, getElementsByTagName

// OPCIONES usando tecnicas diferentes para obtener los datos del servidor,
...
// 4. php lee xml y procesa para crear un array, envia con json y javascript preocesa la respuesta para crear el dom, getJSON_API();
// usa console.log para ver la naturaleza de los datos en los diferentes puntos del envio
// cuidado !! con los echo y los print en php ya que eso altera los datos retornados y dejara de funcionar el cliente
