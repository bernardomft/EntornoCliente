<?php
 /*
- todo a javascript
- cortocircuitar la validadcion HTML5
- el formulario no sale del cliente no hay que guardar los valores porque ya estan
- el codigo es ligeramente mas sencillo que la solucion solo php, estamos mas cerca del DOM que al final es la estructura de datos que queremos modificar, no gestionamos recepciones y envios
- las expresiones regulares pueden ser utilizadas por javascript y php, incluso la misma cadena
- la funcion validar cortocircuita el submit del formulario

lenguaje: validar-js , input[type=text]:focus , onsubmit 
